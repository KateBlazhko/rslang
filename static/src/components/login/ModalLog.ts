...
class ModalLog {
  ...
  constructor() {
    ...
    this.outModal = new Control(null, 'div', 'out__modal', 'Are you sure you want to log out of your account? You will be redirected to the home page and will be able to continue as an unauthorized user.');
